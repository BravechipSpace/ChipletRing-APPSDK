//
//  PPGBloodPressureConfig_Dialog.swift
//  BCLRingSDKDemo
//
...
class PPGBloodPressureConfig_Dialog: UIView {
    ...
    @objc func confirmButtonTapped() {
        ...
        BDLogger.info("PPG血压曲线测量配置 - 采集时间:\(collectTime), 波形配置:\(waveformConfig), 进度配置:\(progressConfig)")
