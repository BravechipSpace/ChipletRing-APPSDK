...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.ambiqmicro.bluetooth.le.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.ambiqmicro.bluetooth.le.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.ambiqmicro.bluetooth.le.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.ambiqmicro.bluetooth.le.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA =
            "com.ambiqmicro.bluetooth.le.EXTRA_DATA";
    public final static String ACTION_GATT_WRITE_RESULT =
            "com.ambiqmicro.bluetooth.le.ACTION_WRITE_RESULT";
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        //使能通知，前面判断了characteristic
        mBluetoothGatt.setCharacteristicNotification(characteristic, enabled);
        if(enabled){
            Log.i(TAG, "=== enableNotification isWriting = true ===");
        }
        // This is specific to Heart Rate Measurement.
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid()) ||
                UUID_AMOTA_TX.equals(characteristic.getUuid())) {
